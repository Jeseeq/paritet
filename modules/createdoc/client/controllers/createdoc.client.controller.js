'use strict';
angular.module('createdoc').controller('CreatedocController', ['$scope','$rootScope', '$stateParams','$location','Authentication','documentData', '$log', '$uibModal',
  function ($scope, $rootScope, $stateParams, $location, Authentication, documentData, $log, $uibModal, $q, $http) {

    $rootScope.popoverFlag = true;

    // close popover
    $rootScope.popoverClose = function(){
      $rootScope.popoverFlag = false;
    };
